...
insert into messenger_db.chat (type_id)
values (1);
insert into messenger_db.chat (type_id)
values (1);

insert into messenger_db.chat_participant (chat_id, user_id)
values (1, 1);
insert into messenger_db.chat_participant (chat_id, user_id)
values (1, 2);

insert into messenger_db.message (chat_id, user_id, created_at, content)
