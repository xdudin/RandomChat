...
-- -----------------------------------------------------
-- Table `messenger_db`.`chat_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `messenger_db`.`chat_type`;

CREATE TABLE IF NOT EXISTS `messenger_db`.`chat_type`
(
    `id`   TINYINT(1) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `messenger_db`.`chat`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `messenger_db`.`chat`;

CREATE TABLE IF NOT EXISTS `messenger_db`.`chat`
(
    `id`      INT UNSIGNED        NOT NULL AUTO_INCREMENT,
    ...
    CONSTRAINT `type_id_fk`
        FOREIGN KEY (`type_id`)
            REFERENCES `messenger_db`.`chat_type` (`id`)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION
)
    ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `messenger_db`.`chat_participant`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `messenger_db`.`chat_participant`;

CREATE TABLE IF NOT EXISTS `messenger_db`.`chat_participant`
(
    `chat_id` INT UNSIGNED NOT NULL,
    `user_id` INT UNSIGNED NOT NULL,
    INDEX `user_id_fk_dp_idx` (`user_id` ASC) VISIBLE,
    INDEX `chat_id_fk_dp_idx` (`chat_id` ASC) VISIBLE,
    PRIMARY KEY (`user_id`, `chat_id`),
    CONSTRAINT `chat_id_fk_dp`
        FOREIGN KEY (`chat_id`)
            REFERENCES `messenger_db`.`chat` (`id`)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION,
...
(
    ...
    INDEX `chat_id_fk_idx` (`chat_id` ASC) VISIBLE,
    CONSTRAINT `chat_id_fk_msg`
        FOREIGN KEY (`chat_id`)
            REFERENCES `messenger_db`.`chat_participant` (`chat_id`)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION,
    CONSTRAINT `user_id_fk_msg`
        FOREIGN KEY (`user_id`)
            REFERENCES `messenger_db`.`chat_participant` (`user_id`)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION
)
    ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Placeholder table for view `messenger_db`.`chat_view`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `messenger_db`.`chat_view`
(
    `id`   INT,
    `name` INT
);
...
-- -----------------------------------------------------
-- View `messenger_db`.`chat_view`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `messenger_db`.`chat_view`;
DROP VIEW IF EXISTS `messenger_db`.`chat_view`;
USE `messenger_db`;
create OR REPLACE view chat_view as
select d.id, dt.name
from messenger_db.chat as d
         join messenger_db.chat_type as dt
              on d.type_id = dt.id;
...
INSERT INTO `messenger_db`.`chat_type`
VALUES (1, 'normal');
INSERT INTO `messenger_db`.`chat_type`
VALUES (2, 'flirtation');
INSERT INTO `messenger_db`.`chat_type`
